...
class CriticalityAnalyzer:
    ...
    def calculate_branching_parameter(
        ...
        """
        Calculate branching parameter σ from activity timeseries.
        ...
        # Calculate branching parameter: σ = <n_{t+1}> / <n_t>
...
class SelfReferenceAnalyzer:
    ...
    def measure_self_prediction_accuracy(
        ...
        # R score (like R² but for self-reference)
...
class IntegratedInformationAnalyzer:
    """
    Calculate integrated information Φ approximations.
    """
    ...
    def _phi_correlation(self, states: np.ndarray) -> float:
        """Correlation-based Φ approximation."""
        ...
        try:
            ...
            # Φ ≈ average absolute correlation
            n = corr.shape[0]
    ...
    def _phi_partition(self, states: np.ndarray) -> float:
        """Partition-based Φ (simplified IIT)."""
...
class ConsciousnessMetricsCalculator:
    """
    Calculate complete C(t) = Φ(t) × R(t) × D(t).
    """
