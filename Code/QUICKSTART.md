...
print(f"C_critical = {results['mean_C_critical']:.2f} ± {results['std_C_critical']:.2f}")

# Test branch number
results = validator.test_branch_number(n_trials=5)
print(f"Branches = {results['mean_branches']:.1f} ± {results['std_branches']:.1f}")
```
...
- **Branching parameter**: σ ≈ 1.0 (criticality)
- **Branches**: 4-5 (post-transition states)

---

**Ready to explore consciousness dynamics!** 🧠✨
